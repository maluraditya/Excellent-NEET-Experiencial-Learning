...
export interface Topic {
  ...
  // Tags
  branch: 'Physical Chemistry' | 'Inorganic Chemistry' | 'Organic Chemistry' | 'Mechanics' | 'Electromagnetism' | 'Thermodynamics' | 'Statistical Mechanics' | 'Genetics' | 'Botany' | 'Zoology' | 'Optics' | 'Modern Physics' | 'Electronics';
  unit: string;
  grade: '11th' | '12th';
}
